...
{
    public abstract class LegalpediaWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LegalpediaWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LegalpediaWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LegalpediaDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LegalpediaDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LegalpediaDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LegalpediaDbContext, Task<T>> func)
        {
            T result;
