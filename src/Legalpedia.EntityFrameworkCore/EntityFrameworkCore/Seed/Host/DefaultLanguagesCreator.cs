...
namespace Legalpedia.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly LegalpediaDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = LegalpediaConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(LegalpediaDbContext context)
        {
            _context = context;
        }
